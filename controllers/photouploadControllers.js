...
const photouploadPagePost = async (req, res)=>{
	...
	try {
	  ...
	  //kontrollin, kas vesimأ¤rgi fail on olemas
		...
		//loon normaalmأµأµdus foto (800X600)
        ...
        console.log("Lisan vesimأ¤rgi" + watermarkSettings.length);    
	  ...
	  //kuna kasutajakontosid veel ei ole, siis mأ¤أ¤rame userid = 1
	  const userId = 1;
